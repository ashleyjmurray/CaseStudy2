...
```{r out.width="75%",out.height="75%",fig.show='hold',fig.align='center', fig.cap="Histogram of Raw Sensor Data (Chest-Data Only for Subject 2)"}
set.seed(1)
...
title <- ggdraw() +
  draw_label(
    "Histogram of Raw Sensor Data (Chest-Data Only for Subject 3)",
    x = 0,
    hjust = 0
  ) +
  theme(
...
title <- ggdraw() +
  draw_label(
    "Histogram of Raw Sensor Data (Chest-Data Only for Subject 4)",
    x = 0,
    hjust = 0
  ) +
  theme(
