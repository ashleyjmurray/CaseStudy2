...
accuracy_table %>%
  mutate_if(is.numeric, round, digits=3) %>%
  kableExtra::kable(booktabs = T,
                    caption = "Accuracy (Acc) and F1 Scores for Sensor Data",
                    col.names = c("", "Acc", "F1",
                                  "Acc", "F1",
                                  "Acc", "F1",
                                  "Acc", "F1",
