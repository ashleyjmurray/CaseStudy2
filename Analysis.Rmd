...
To quantify the heterogeneity across individuals, the feature with the largest coefficient in the lasso model from each of the individual devices was processed into a logistic regression model to predict stress vs. amusement with stress as the baseline. 
